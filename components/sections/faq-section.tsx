...
export function FAQSection() {
  ...
  return (
    <section id="faq" className="mx-auto max-w-4xl px-5 pt-24 sm:px-8 lg:pt-32">
      ...
      <div className="mt-16 divide-y divide-[var(--border)] rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-xs sm:p-8 lg:mt-20">
        {FAQS.map((faq, index) => {
          ...
          return (
            <div key={faq.question} className="py-5 first:pt-0 last:pb-0">
              <button
                ...
                className="flex w-full items-center justify-between text-left text-base font-semibold text-[var(--ink)] transition-colors hover:text-[var(--accent)]"
